...
export default function CarouselTemplate({carouselData}:CarouselTemplateProps) {
    return (
        ...
        <Carousel key={index} className="w-full h-full max-w-2xl" >
            <CarouselContent >
                    ...
                    <div className="relative">
                        <Card>
                            ...
                            <div className="relative w-full h-full">
                                <Image className="w-full h-full opacity-100 hover:opacity-25 transition-opacity" alt={carouselItem.alt} src={carouselItem.src} layout="fill" />
